# RYZ3N Core — Current Repository Map
...
Legacy files may use `Ryzen`; current project representation is **RYZ3N**.
...
| `02-ryzen/` | RYZ3N definition/architecture maps and legacy naming references |
| `03-recovery-integration/` | Recovery evidence integration |
| `04-rebuild-integration/` | Rebuild-spec integration |
| `05-adrs/` | RYZ3N Core architectural decisions |
| `06-runtime-roadmap/` | Historical/planned runtime roadmap interpreted through current reality |
| `07-runtime-scaffolding/` | Runtime scaffolding; directory presence is not proof of implementation |
...
Do not “fix” historical numbering by deleting/renaming old folders. Preserve history and use this map/current overlays as the navigation layer.
